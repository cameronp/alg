-file("c:/Program Files/erl10.0.1/lib/parsetools-2.1.7/include/leexinc.hrl", 0).
...
-file("c:/Program Files/erl10.0.1/lib/parsetools-2.1.7/include/leexinc.hrl", 14).
...
yystate(11, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
yystate(11, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
yystate(5, [10|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line+1, Tlen+1, 1, Tlen);
...
yyaction_7(TokenChars, TokenLine) ->
     handle_letter_vars (TokenChars, TokenLine) .
...
-file("c:/Program Files/erl10.0.1/lib/parsetools-2.1.7/include/leexinc.hrl", 313).
